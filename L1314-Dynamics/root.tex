...
\begin{displaymath}
Q_{i} = \frac{d}{dt}\left(\frac{2L}{2\dot{d}_{i}}\right) - \frac{\partial L}{\partial q_{i}}
\end{displaymath}
...
\end{eqnarray}
With a lot of factoring, we can smoosh this into the form
\begin{eqnarray}
K\!\left(\underline{q}, \underline{\dot{q}}\right) & = & \frac{1}{2}\underline{\dot{q}}^{T}M(\underline{q})\underline{\dot{q}} +  C(\underline{q})\underline{\dot{q}} + B(\underline{q})\dot{\underline{q}} \nonumber
\end{eqnarray}
Also,
\begin{equation}
...
Thus, the dynamics of a manipulator can be expressed in full as 
\begin{equation}
	\underline{\tau} = \frac{1}{2}\underline{\dot{q}}^{T}M(\underline{q})\underline{\dot{q}} +  C(\underline{q})\underline{\dot{q}} + B(\underline{q})\dot{\underline{q}} + E(\underline{q})
\end{equation}
This is known as a ``Hamiltonian system'', and is quite general. $E(\cdot)$ can also end up including frictional terms or other terms exerted on the manipulator by the environment.
...
\begin{equation}
\underline{\tau} = M(\underline{q})\ddot{q} + B(\underline{q})[\underline{\dot{q}}\underline{\dot{q}}] + C(\underline{q})[\underline{\dot{q}}^{2}]+G(\underline{q})g \nonumber
\end{equation}
where
\begin{displaymath}
