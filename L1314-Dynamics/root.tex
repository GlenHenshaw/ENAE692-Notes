...
\end{equation}
where $E(\underline{q}) = \frac{\partial P}{\partial\underline{q}}$ (note that $\frac{\partial K}{\partial\underline{q}}=\underline{0}$).
