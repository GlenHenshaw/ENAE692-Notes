...
\end{eqnarray}
Multiplying both sides by $^{i}_{0}R$, noting that $^{i}\underline{\Omega}_{i+1} = \ ^{i}_{i+1}R\ ^{i+1}\hat{z}_{i+1}\dot{\Theta}_{i+1}$, expanding $^{i}\dot{\underline{\Omega}}_{i+1}$, and recalling that $^{i}_{i+1}\dot{R} = ^{i}\underline{\Omega}_{i+1}\ ^{i}_{i+1}R$ gives
\begin{eqnarray}
