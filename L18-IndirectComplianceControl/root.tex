...
\begin{eqnarray}
 ...
 \Rightarrow \ddot{\underline{x}}_{d} & = & K_{m}^{-1}\left[\underline{F} - K_{v}\left(\underline{\dot{x}}_{r} - \underline{\dot{x}}_{d}\right) - K_{p}\left(\underline{x}_{r}-\underline{x}_{d}\right) - K_{m}\underline{\ddot{x}}_{r}\right] \label{CC1}
 \end{eqnarray}
