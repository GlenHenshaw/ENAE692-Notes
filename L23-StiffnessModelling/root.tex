...
\end{eqnarray}
Link: $\delta x_{L} = 100\ \text{N}/1.476\times10^{6}\ \text{N-m} = 6.78\times 10^{-5}\ \text{N/m}$

\noindent
Shaft: $\delta x_{S} = (0.50\ \text{m})(0.5\ \text{m} \times100\ \text{N})/1530\ \text{N--m/rad} = 0.0163\ \text{N--m/rad}$
