...
\end{figure}
\begin{eqnarray}
	K_{shaft} & = & \frac{G\pi d^{4}}{32 l} = \frac{(7.5\times16^{10})(\pi)(5\times 10^{-3})^{4}}{32(0.3)} = 15.3\ \text{N-m/rad} \rightarrow K_{S_{out}} = 15.3(10)^{2} = 1530\ \text{N--m/rad} \nonumber \\
	K_{link} & = & \frac{E(w_{o}^{4}-w_{i}^{4})}{4l^{3}} = \frac{(2\times10^{11})(0.05^{4}-0.04^{4})}{4(0.5)^{3}} = 1.476\times 10^{6}\ \text{N/m} \nonumber
\end{eqnarray}
Link: $\delta x_{L} = 100\ \text{N}/1.476\times10^{6}\ \text{N-m} = 6.78\times 10^{-5}\ \text{m}$

\noindent
Shaft: $\delta x_{S} = (0.50\ \text{m})(0.5\ \text{m} \times100\ \text{N})/1530\ \text{N--m/rad} = 0.0163\ \text{m}$
